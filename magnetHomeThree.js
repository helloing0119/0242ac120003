...
function toggleNetworkDark() {
  whiteModeNetwork = !whiteModeNetwork;
  if (whiteModeNetwork) {
    sceneNetwork.background = new THREE.Color(0xf8f8f8);
    logoNetworkGroup.children[0].material.color.setHex(0x1f1f1f);
    logoNetworkGroup.children[1].material.color.setHex(0x1f1f1f);
  }
  else {
    sceneNetwork.background = new THREE.Color(0x1f1f1f);
    logoNetworkGroup.children[0].material.color.setHex(0xf8f8f8);
    logoNetworkGroup.children[1].material.color.setHex(0xf8f8f8);
  }
}
...
function initThreeStrength(id, width, height) {
  if (id == undefined) {
    ...
    canvasStrengthDom = document.getElementsByClassName(id)[0];
