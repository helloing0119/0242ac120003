...
function initThreeStrength(id,width,height){if(id==undefined){canvasStrengthDom=document.body}else canvasStrengthDom=document.getElementsByClassName(id)[1];if(width==undefined){width=canvasStrengthDom.offsetWidth}
